...
addi $4, $0, 1			# r4 = 1
addi $4,$3,1			#r4=r3+1=	0x7FFFFFFF+1=0x80000000 (overflow addition happened)
add $6, $1, $4			# r6 = 65535 + 1 = 65536  (normal addition) (then how about overflow addition?)
add $6, $3, $4			# r6 =  0x7FFFFFFF(hex)+ 1 =   (normal addition) (overflow addition happened)

sub $7, $0, $3			# r7 = 0-r3 = 0x80000001(hex) = -2147483647(decimal)
sub $9, $1, $4			# r9 = r1 - r4 = 65535 - 1 = 65534 (normal sub) (then how about overflow sub?)
sub $9, $7, $4			# r9 = r7 - r4 = 0x80000001(hex) - 1 = 
sub $9, $9, $4			# r9 = r9 - r4 = 0x80000000(hex) - 1 = ( overflow sub happened)
